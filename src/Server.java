...
public class Server {
	...
	private final int listenPort = 47511;
		...
		try {
			...
			while (!exit){
				...
				case Utils.CLOSE_SOCKET:
					...
					//TODO: QUITAR "Pedro". HACER QUE LO COJA DEL BUFFER QUE LE LLEGA CON CLOSE_SOCKET.
					sock2peer = clientManager.getUserSocket("Pedro", false);
					//////////////////////////////////////////////////////////////////////////////////
